...
async function subscribe(){
    const key = "BBiCpC5UqM_wOrdoXNM34QWDNQES1gav-uVXDRumjTwd0xkvigmcdmt7ib6NTbK_upNBmk-DTFEICZG3HdTfFFw";
    ...
    try{
        ...
        console.error("Subscribe failed, please try again.")
    }
}
          ...
          <div className="container mx-auto min-h-screen">
            <div className="flex flex-col items-center justify-center">
              <div className="w-full md:w-4/12 text-center">
                ...
                <h2 className="text-xl font-semibold mb-1">Wilbert</h2>
                <p className="text-lg mb-12">FullStack Developer</p>
              </div>
            </div>
